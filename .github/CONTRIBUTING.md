...
You can file new issues by filling out our [new issue form](https://github.com/devCrossNet/quaire/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)

Before you submit your Pull Request (PR) consider the following guidelines:

- Search [GitHub](https://github.com/devCrossNet/quaire/pulls) for an open or closed PR
...
- In GitHub, send a pull request to `quaire:main`.
...
[github]: https://github.com/devCrossNet/quaire/issues
